...
A Chrome extension that autonomously builds clinical trial study structures in eSource web platforms from a JSON specification file. Driven by Gemini 2.0 Flash (vision + reasoning) — no hardcoded UI selectors.
